...
const Footer = () => {
  return (
    <footer className='bg-[#F90070] py-2 mt-16 text-white'>
        
        <section className='grid grid-cols-3 text-sm p-2 max-sm:grid-cols-1 max-sm:gap-y-4 '>
            <div className='flex flex-col items-center'>
                <h2 className='text-2xl font-semibold mb-2'>AcademIQ</h2>
                <p>Empowering learners every step of the way. Skill up with confidence, anywhere, anytime.</p>
                <div className='flex justify-evenly w-full *:cursor-pointer *:hover:bg-black my-3 *:bg-gray-800 *:p-1'>
